...
/**
 * @brief Get the current wake status.
 *
 * @return Current wake status byte.
 */
...
/**
 * @brief Generate a wake event with the specified reason.
 *
 * @param wake_reason The wake reason to set.
 */
...
/**
 * @brief Check if ACPI offset is write permitted.
 *
 * @param offset The ACPI table offset to check.
