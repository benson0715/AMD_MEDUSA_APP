...
#define EC_VERSION_STRING_1_VALUE     "MEDUSAPLUM"         /* 0x200A: 10-bytes */
#define EC_VERSION_STRING_2_VALUE     "2026-03-20"         /* 0x2014: 10-bytes */
#define EC_VERSION_STRING_3_VALUE     "0.2.A"              /* 0x201E:  5-bytes */
#define EC_VERSION_STRING_4_VALUE     "7321 "              /* 0x2023:  5-bytes */
#define EC_VERSION_STRING_5_VALUE     "."           /* 0x2028:  Repository Version; Local changes flag(*|.) */
#define EC_VERSION_STRING_6_VALUE     "163349"             /*          Build time */
#define EC_VERSION_STRING_7_VALUE     "f353754276c2a4ae020089d072efb26f515cf5f3" /* VERSION SHA1SUM */
#define EC_VERSION_U32_MAGIC          0x30634C22ul         /* uint32_t magic of SHA1SUM */
