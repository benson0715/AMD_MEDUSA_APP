...
{
	_s_bidCfg = 0;
	if(BRDID_isHemlock ||BRDID_isSequoia) return;
	/* dynamic check PD module vendor */
#if CONFIG_USBC_4CC
	if (app_4cc_vonderIdentify()) {
...
#endif
#if CONFIG_USBC_CCGX
    if (app_ccgx_vonderIdentify()) {
		_SET_CFG_(PD0, CCG8DF);
		_SET_CFG_(PD1, CCG8SF);
		LOG_DBG ("detect CCGx");
	} else
#endif
#if (CONFIG_USBC_ITE)
	if (app_ite_vonderIdentify()) {
		_SET_CFG_(PD0, IT8857);
		_SET_CFG_(PD1, IT8858);
		LOG_DBG ("detect ite");
	} else
#endif
#if (CONFIG_USBC_RTK)
...
bool brdId_isPEO(void)
{
	...
	if (!BRDID_isDAP) {
		...
		//    08    PCBA: Plum (9600 w/ mid-loss), SLT Rev B,  FP10 No APU 28W Max, LPDDR5x No Pop, EC onboard
		...
		if ((1 == brdId() || 2 == brdId()) && (4 == sku || 8 == sku)) {
			isPeo = true;
		}
	}
...
bool brdId_isDM(void)
{
	...
	/*
	 * SKU2: PCBA: Plum (9600 w/ mid-loss), Rev B, FP10 DM 28W Max, LPDDR5x No Pop, EC onboard
	 * SKU3: PCBA: Plum (9600 w/ mid-loss), Rev B, FP10 DM 45W Max, LPDDR5x No Pop, EC onboard
	 * SKU6: PCBA: Plum (9600 w/ mid-loss), Rev B, FP10 DM 80W Max, LPDDR5x No Pop, EC onboard
	 * */
	if (1 == brdId()) {
		if (sku == 2 || sku == 3 || sku == 6) {
			isDM = true;
		}
	}

	/*
	 * SKU2: PCBA: Plum DAP(9600 w/ mid-loss), Rev A, FP10 DM 28W, LPDDR5x No Pop, EC onboard
	 * SKU3: PCBA: Plum DAP(9600 w/ mid-loss), Rev A, FP10 DM 45W, LPDDR5x No Pop, EC onboard
	 * SKU4: PCBA: Plum DAP(9600 w/ mid-loss), Rev A, FP10 DM 80W, LPDDR5x No Pop, EC onboard
	 * */
	else if (6 == brdId()) {
		if (sku == 2 || sku == 3 || sku == 4) {
			isDM = true;
		}
	}

	/*
	 * SKU3: PCBA: Pine (8533 w/ FR4), Rev A , FP10 DM 28W Max, LPDDD5x No Pop, EC onboard
	 * SKU4: PCBA: Pine (8533 w/ FR4), Rev A , FP10 DM 45W Max, LPDDD5x No Pop, EC onboard
	 * SKU5: PCBA: Pine (8533 w/ FR4), Rev A , FP10 DM 80W Max, LPDDD5x No Pop, EC onboard
	 * */
	else if (4 == brdId()) {
		if (sku == 3 || sku == 4 || sku == 5) {
			isDM = true;
		}
	}

	/*
	 * SKU2: PCBA: Hickory Rev B, FP10 DM 28W Max, DDR5 CSODIMM, EC onboard
	 * SKU3: PCBA: Hickory Rev B, FP10 DM 45W Max, DDR5 CSODIMM, EC onboard
	 * SKU6: PCBA: Hickory Rev B, FP10 DM 80W Max, DDR5 CSODIMM, EC onboard
	 * */
	else if (2 == brdId()) {
		if (sku == 2 || sku == 3 || sku == 6) {
			isDM = true;
	...
	/*
	 * SKU2: PCBA: Hickory DAP Rev A, FP10 DM 28W Max, DDR5 CSODIMM, EC onboard
	 * SKU3: PCBA: Hickory DAP Rev A, FP10 DM 45W Max, DDR5 CSODIMM, EC onboard
	 * SKU4: PCBA: Hickory DAP Rev A, FP10 DM 80W Max, DDR5 CSODIMM, EC onboard
	 * */
	else if (7 == brdId()) {
		if (sku == 2 || sku == 3 || sku == 4) {
			isDM = true;
	...
	/*
	 * SKU2: PCBA: Juniper Rev A, FP10 DM 28W, LPCAMM2, EC onboard
	 * SKU3: PCBA: Juniper Rev A, FP10 DM 45W, LPCAMM2, EC onboard
	 * SKU4: PCBA: Juniper Rev A, FP10 DM 80W, LPCAMM2, EC onboard
	 * */
	else if (3 == brdId()) {
		if (sku == 2 || sku == 3 || sku == 4) {
			isDM = true;
	...
	/*
	 * SKU2: PCBA: Juniper DAP Rev A, FP10 DM 28W, LPCAMM2, EC onboard
	 * SKU3: PCBA: Juniper DAP Rev A, FP10 DM 45W, LPCAMM2, EC onboard
	 * SKU4: PCBA: Juniper DAP Rev A, FP10 DM 80W, LPCAMM2, EC onboard
	 * */
	else if (8 == brdId()) {
		if (sku == 2 || sku == 3 || sku == 4) {
			isDM = true;
...
BID_MDS_CPU_TYPE brdId_CpuOpnType(void)
{
	...
	/*
	 * SKU1: PCBA: Plum (9600 w/ mid-loss), Rev B, FP10 No APU 45W Max, LPDDR5x No Pop, EC onboard
	 * SKU2: PCBA: Plum (9600 w/ mid-loss), Rev B, FP10 DM 28W Max, LPDDR5x No Pop, EC onboard
	 * SKU3: PCBA: Plum (9600 w/ mid-loss), Rev B, FP10 DM 45W Max, LPDDR5x No Pop, EC onboard
	 * SKU4: PCBA: Plum (9600 w/ mid-loss), SLT Rev B, FP10 No APU 45W Max, LPDDR5x No Pop, EC onboard
	 * SKU5: PCBA: Plum (9600 w/ mid-loss), Rev B, FP10 No APU 45W Max, LPDDR5x No Pop, Support EC module
	 * SKU6: PCBA: Plum (9600 w/ mid-loss), Rev B, FP10 DM 80W Max, LPDDR5x No Pop, EC onboard
	 * SKU7: PCBA: Plum (9600 w/ mid-loss), SLT Rev B,  FP10 No APU 28W Max, LPDDR5x No Pop, EC onboard
	 * SKU8: PCBA: Plum (9600 w/ mid-loss), Rev B, FP10 No APU 28W, LPDDR5x No Pop, EC onboard
	 * */
	if (1 == brdId()) {
		if (sku == 2) {
			...
			opn = BID_MDS_CPU_TYPE_80W;
		}
	}

	/*
	 * SKU1: PCBA: Plum DAP(9600 w/ mid-loss), Rev A, FP10 No APU 45W, LPDDR5x No Pop, EC onboard
	 * SKU2: PCBA: Plum DAP(9600 w/ mid-loss), Rev A, FP10 DM 28W, LPDDR5x No Pop, EC onboard
	 * SKU3: PCBA: Plum DAP(9600 w/ mid-loss), Rev A, FP10 DM 45W, LPDDR5x No Pop, EC onboard
	 * SKU4: PCBA: Plum DAP(9600 w/ mid-loss), Rev A, FP10 DM 80W, LPDDR5x No Pop, EC onboard
	 * SKU5: PCBA: Plum DAP(9600 w/ mid-loss), Rev A, FP10 No APU 28W, LPDDR5x No Pop, EC onboard
	 * */
	else if (6 == brdId()) {
		if (sku == 2) {
			opn = BID_MDS_CPU_TYPE_28W;
	...
	/*
	 * SKU1: PCBA: Pine (8533 w/ FR4), Rev A , FP10 No APU 45W Max, LPDDD5x No Pop, EC onboard
	 * SKU2: PCBA: Pine (8533 w/ FR4), Rev A , FP10 No APU 28W , LPDDD5x No Pop, EC onboard
	 * SKU3: PCBA: Pine (8533 w/ FR4), Rev A , FP10 DM 28W Max, LPDDD5x No Pop, EC onboard
	 * SKU4: PCBA: Pine (8533 w/ FR4), Rev A , FP10 DM 45W Max, LPDDD5x No Pop, EC onboard
	 * SKU5: PCBA: Pine (8533 w/ FR4), Rev A , FP10 DM 80W Max, LPDDD5x No Pop, EC onboard
	 * */
	...
	/*
	 * SKU1: PCBA: Hickory Rev B, FP10 No APU 45W Max, DDR5 CSODIMM, EC onboard
	 * SKU2: PCBA: Hickory Rev B, FP10 DM 28W Max, DDR5 CSODIMM, EC onboard
	 * SKU3: PCBA: Hickory Rev B, FP10 DM 45W Max, DDR5 CSODIMM, EC onboard
	 * SKU4: PCBA: Hickory Rev B, SLT Rev B, FP10 No APU 45W, DDR5 CSODIMM , EC onboard
	 * SKU5: PCBA: Hickory Rev B, FP10 No APU 80W Max, DDR5 CSODIMM, Support EC module
	 * SKU6: PCBA: Hickory Rev B, FP10 DM 80W Max, DDR5 CSODIMM, EC onboard
	 * SKU7: PCBA: Hickory Rev B, FP10 No APU 28W Max, DDR5 CSODIMM, EC onboard
	 * SKU8: PCBA: Hickory Rev B, SLT Rev B, FP10 No APU 28W Max, DDR5 CSODIMM , EC onboard
	 * */
	else if (2 == brdId()) {
		if (sku == 2) {
			opn = BID_MDS_CPU_TYPE_28W;
	...
	/*
	 * SKU1: PCBA: Hickory DAP Rev A, FP10 No APU, 45W, DDR5 CSODIMM, EC onboard
	 * SKU2: PCBA: Hickory DAP Rev A, FP10 DM 28W Max, DDR5 CSODIMM, EC onboard
	 * SKU3: PCBA: Hickory DAP Rev A, FP10 DM 45W Max, DDR5 CSODIMM, EC onboard
	 * SKU4: PCBA: Hickory DAP Rev A, FP10 DM 80W Max, DDR5 CSODIMM, EC onboard
	 * SKU5: PCBA: Hickory DAP Rev A, FP10 No APU, 28W, DDR5 CSODIMM, EC onboard
	 * */
	else if (7 == brdId()) {
		if (sku == 2) {
			opn = BID_MDS_CPU_TYPE_28W;
	...
	/*
	 * SKU1: PCBA: Juniper Rev A, FP10 No APU 45W, LPCAMM2, EC onboard
	 * SKU2: PCBA: Juniper Rev A, FP10 DM 28W, LPCAMM2, EC onboard
	 * SKU3: PCBA: Juniper Rev A, FP10 DM 45W, LPCAMM2, EC onboard
	 * SKU4: PCBA: Juniper Rev A, FP10 DM 80W, LPCAMM2, EC onboard
	 * SKU5: PCBA: Juniper Rev A, FP10 No APU 28W, LPCAMM2, EC onboard
	 * */
	else if (3 == brdId()) {
		if (sku == 2) {
			opn = BID_MDS_CPU_TYPE_28W;
	...
	/*
	 * SKU1: PCBA: Juniper DAP Rev A, FP10 No APU 45W, LPCAMM2, EC onboard
	 * SKU2: PCBA: Juniper DAP Rev A, FP10 DM 28W, LPCAMM2, EC onboard
	 * SKU3: PCBA: Juniper DAP Rev A, FP10 DM 45W, LPCAMM2, EC onboard
	 * SKU4: PCBA: Juniper DAP Rev A, FP10 DM 80W, LPCAMM2, EC onboard
	 * SKU5: PCBA: Juniper DAP Rev A, FP10 No APU 28W, LPCAMM2, EC onboard
	 * */
	else if (8 == brdId()) {
		if (sku == 2) {
			opn = BID_MDS_CPU_TYPE_28W;
		...
		/* If cannot get valid board id, set to NA */
...
/**
 * @brief check if system support memory PMIC based on board id
 *
 * @retval True is support memory PMIC
 */
bool brdId_supportMemPMIC(void)
{
	if (BRDID_isPlum) {
		return false;
	} else if (BRDID_isJuniper || BRDID_isHickory) {
		return true;
	}
	return false;
}
...
void brdId_transitionToS5(void)
{
	 ...
	 */
	ioexp_set(ex_EP_SSD1_PWREN, 0); // IO_6  = 0
...
#endif
#if CONFIG_USBC_CCGX
	else if (CHECK_CFG(PD0, CCG8DF) || CHECK_CFG(PD1, CCG8SF)) {
		/* Set IFX to sink only S5 -> G3 */
		amd_crb_drivers_hpi_allPortsSinkOnly(0);
#if PD_TRIPPORT_ENABLE
		amd_crb_drivers_hpi_allPortsSinkOnly(1);
#endif
	}
#endif
}
...
void brdId_pdPowerRoleS5(void)
{
	...
	if (CHECK_CFG(PD0, TPS66994BF) || CHECK_CFG(PD1, TPS66994BF)) {
		...
		amd_crb_drivers_hpi_allPortsDrp(0);
#if PD_TRIPPORT_ENABLE
		amd_crb_drivers_hpi_allPortsDrp(1);
#endif
	}
#endif
}
...
/**
 * @brief check if board revision is Rev C
 *
