 ...
 ***************************************************************************************************/
    ...
    {GPIO01,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO01      
 ...
 ***************************************************************************************************/
    ...
    {EC_SCROLL_LED_N,    GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,                         GPIO_CTRL_PWRG_VTR_IO      },    // GPIO32      
    ...
    {EC_NUM_LED_N,       GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,                         GPIO_CTRL_PWRG_VTR_IO      },    // GPIO35      
    {EP_EC_INT_N,        GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO36      
 ...
 ***************************************************************************************************/
    ...
    {EC_AC_PD_N,         GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO45      
 ...
 ***************************************************************************************************/
    {EC_DT_SLT_AUX_RST_N, GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_OFF         },    // GPIO60      
 ...
 ***************************************************************************************************/
    ...
    {GPIO81,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO81      
 ...
 ***************************************************************************************************/
    {TNR_EC_INT_N,       GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC0      
    ...
    {EC_PWM0,            GPIO_INPUT,                                                 GPIO_CTRL_PWRG_OFF         },    // PWM0        
 ...
 ***************************************************************************************************/
    ...
    {HDR_DOCK_IN_N,      GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIOD3      
    {EC_JTAG_TDO_SWO,    GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
    {EC_JTAG_TCK_SWCLK,  GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
    {EVAL_PRSNT_N_EC,    GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIOD6      
 ...
 ***************************************************************************************************/
    ...
    {EC_JTAG_TDI,        GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
 ...
 ***************************************************************************************************/
    ...
    {KBRST_N,            GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,                         GPIO_CTRL_PWRG_VTR_IO      },    // GPIOF5      
...
void __autogen_AcpiHandler_GIO0 (uint8_t isRead, uint8_t ui8Idx, uint8_t * pui8Data)
{
    ...
    if (isRead) {
        retVal |= gpio_read_pin( AC_PRSNT_N )           ? 0x01 : 0x00;	// GPIO42/AD3/RI#
        retVal |= gpio_read_pin( EVAL_PWRGD )           ? 0x02 : 0x00;	// KSO17/GPIOB1/CR_SIN4
        retVal |= gpio_read_pin( EVAL_PRSNT_N_EC )      ? 0x04 : 0x00;	// GPIOD6/CR_SOUT3/FLM_CSI#
        retVal |= gpio_read_pin( EC_TPAD_TYP_GUARD_N )  ? 0x08 : 0x00;	// GPIO67/PS2_CLK0/AD18
        ...
        retVal |= gpio_read_pin( SYSTEM_S5_PG )         ? 0x80 : 0x00;	// GPIOC5/KBRST#
        ...
        gpio_write_pin( AC_PRSNT_N ,          (retVal & 0x01) ? 1 : 0 );	// GPIO42/AD3/RI#
        gpio_write_pin( EVAL_PWRGD ,          (retVal & 0x02) ? 1 : 0 );	// KSO17/GPIOB1/CR_SIN4
        gpio_write_pin( EVAL_PRSNT_N_EC ,     (retVal & 0x04) ? 1 : 0 );	// GPIOD6/CR_SOUT3/FLM_CSI#
        gpio_write_pin( EC_TPAD_TYP_GUARD_N , (retVal & 0x08) ? 1 : 0 );	// GPIO67/PS2_CLK0/AD18
        ...
        gpio_write_pin( SYSTEM_S5_PG ,        (retVal & 0x80) ? 1 : 0 );	// GPIOC5/KBRST#
    }
}
...
void __autogen_AcpiHandler_GIO1 (uint8_t isRead, uint8_t ui8Idx, uint8_t * pui8Data)
{
    ...
    if (isRead) {
        retVal |= gpio_read_pin( EC_TPAD_KB_BLON_N )    ? 0x01 : 0x00;	// GPIO70/PS2_DAT0/AD19
        retVal |= gpio_read_pin( EC_EVAL_CARD_PWREN )   ? 0x02 : 0x00;	// GPIO41/AD4
        ...
        gpio_write_pin( EC_TPAD_KB_BLON_N ,   (retVal & 0x01) ? 1 : 0 );	// GPIO70/PS2_DAT0/AD19
        gpio_write_pin( EC_EVAL_CARD_PWREN ,  (retVal & 0x02) ? 1 : 0 );	// GPIO41/AD4
    }
}
...
void __autogen_AcpiHandler_GIO2 (uint8_t isRead, uint8_t ui8Idx, uint8_t * pui8Data)
{
    ...
    if (isRead) {
        retVal |= gpio_read_pin( EC_SLT_PWRBRK_N )      ? 0x01 : 0x00;	// GPIOC4/PWM2
        retVal |= gpio_read_pin( EC_EVAL_19V_PWREN )    ? 0x04 : 0x00;	// GPIOC6/SMI#
        retVal |= gpio_read_pin( EC_EVAL_SLT_PWREN )    ? 0x20 : 0x00;	// GPIO37/PS2_CLK2/AD5
        retVal |= gpio_read_pin( EC_EVAL_BOMACO_EN )    ? 0x40 : 0x00;	// GPIO34/PS2_DAT2/AD6
        ...
        gpio_write_pin( EC_SLT_PWRBRK_N ,     (retVal & 0x01) ? 1 : 0 );	// GPIOC4/PWM2
        gpio_write_pin( EC_EVAL_19V_PWREN ,   (retVal & 0x04) ? 1 : 0 );	// GPIOC6/SMI#
        gpio_write_pin( EC_EVAL_SLT_PWREN ,   (retVal & 0x20) ? 1 : 0 );	// GPIO37/PS2_CLK2/AD5
        gpio_write_pin( EC_EVAL_BOMACO_EN ,   (retVal & 0x40) ? 1 : 0 );	// GPIO34/PS2_DAT2/AD6
    }
}
...
void __autogen_AcpiHandler_GIO3 (uint8_t isRead, uint8_t ui8Idx, uint8_t * pui8Data)
{
    ...
    if (isRead) {
        retVal |= gpio_read_pin( EC_EVAL_AUX_RST_N )    ? 0x01 : 0x00;	// GPIO44/AD1
        retVal |= gpio_read_pin( EC_LOM_AUX_RST_N )     ? 0x02 : 0x00;	// GPIOF1/AD8
        retVal |= gpio_read_pin( EC_DT_SLT_AUX_RST_N )  ? 0x04 : 0x00;	// GPIO60/PWM7
        retVal |= gpio_read_pin( EC_SD_AUX_RST_N )      ? 0x08 : 0x00;	// GPIO43/AD2
        retVal |= gpio_read_pin( EC_WWAN_AUX_RST_N )    ? 0x10 : 0x00;	// GPIO62/PS2_CLK1/AD16
        ...
        gpio_write_pin( EC_EVAL_AUX_RST_N ,   (retVal & 0x01) ? 1 : 0 );	// GPIO44/AD1
        gpio_write_pin( EC_LOM_AUX_RST_N ,    (retVal & 0x02) ? 1 : 0 );	// GPIOF1/AD8
        gpio_write_pin( EC_DT_SLT_AUX_RST_N , (retVal & 0x04) ? 1 : 0 );	// GPIO60/PWM7
        gpio_write_pin( EC_SD_AUX_RST_N ,     (retVal & 0x08) ? 1 : 0 );	// GPIO43/AD2
        gpio_write_pin( EC_WWAN_AUX_RST_N ,   (retVal & 0x10) ? 1 : 0 );	// GPIO62/PS2_CLK1/AD16
...
void __autogen_AcpiHandler_GIO4 (uint8_t isRead, uint8_t ui8Idx, uint8_t * pui8Data)
{
    ...
    if (isRead) {
        ...
        retVal |= gpio_read_pin( HW_LID_CLOSE_N )       ? 0x02 : 0x00;	// KSO16/GPIO03
        retVal |= gpio_read_pin( HDR_DOCK_IN_N )        ? 0x04 : 0x00;	// GPIOD3/TB1
        retVal |= gpio_read_pin( BAT_PRSNT_N )          ? 0x08 : 0x00;	// PWRGD/GPIO72
        retVal |= gpio_read_pin( TNR_EC_INT_N )         ? 0x10 : 0x00;	// GPIOC0/PWM6/I2C7_SCL1/S_SBUA
        ...
        gpio_write_pin( HW_LID_CLOSE_N ,      (retVal & 0x02) ? 1 : 0 );	// KSO16/GPIO03
        gpio_write_pin( HDR_DOCK_IN_N ,       (retVal & 0x04) ? 1 : 0 );	// GPIOD3/TB1
        gpio_write_pin( BAT_PRSNT_N ,         (retVal & 0x08) ? 1 : 0 );	// PWRGD/GPIO72
        gpio_write_pin( TNR_EC_INT_N ,        (retVal & 0x10) ? 1 : 0 );	// GPIOC0/PWM6/I2C7_SCL1/S_SBUA
    }
}
