 ...
 * MISC 
 *******************/
#define GPIOF5                   EC_GPIO_F5 // GPIO         | .        |            | 

#define POR_INIT_MISC            \
    GPIOF5
 ...
 * BAT_CHG 
 *******************/
#define BAT_PRSNT_N              EC_GPIO_01 // GPIO01       | J4.15    | GPIO33_13  | Notify EC that battery is present, low active
 ...
 * DBG 
 *******************/
#define EC_BLINK_N               EC_GPIO_60 // GPIO60       | J6.21    | GPIO33_10  | Storage acitve indication
...
#define EC_AC_PD_N               EC_GPIO_D3 // GPIOD3       | .        |            | EC to select AC or PD to source system. High = AC, Low = PD
#define EC_ADC_RSVD              EC_GPIO_E1 // GPIO         | J3.16    |            | Reserved for ADC
#define EC_DT_SLT_AUX_RST_N      EC_GPIO_45 // GPIO45       | J6.7     | GPIO33_3   | DT AUX Reset, low active
...
#define EP_EC_INT_N              EC_GPIO_C3 // GPIOC3       | J4.13    | GPIO33_12  | To notify EC expander0 has an interrupt triggered. low active
#define EVAL_PRSNT_N_EC          EC_GPIO_02 // GPIO02       | J4.4     | GPIO33_19  | To notify EC the type of the card inserted in PCIe x8/16 slot
#define EVAL_PWRGD               EC_GPIO_B1 // GPIOB1       | J3.20    | GPIO33_17  | Notify EC,dock is present, low active
#define HDR_DOCK_IN_N            EC_GPIO_E3 // GPIOE3       | .        |            | To enable system's ALWAYS power rails, high active
...
#define POR_INIT_JTAG            \
    EC_JTAG_TCK_SWCLK,            EC_JTAG_TMS_SWIO

/*******************
 * Keyboard 
 *******************/
#define EC_CAP_LED_N             EC_GPIO_C2 // GPIOC2       | J5.25    |            | To light CAP LED, low active
#define EC_NUM_LED_N             EC_GPIO_B7 // GPIOB7       | J5.27    |            | To light NUM LED, low active
#define EC_SCROLL_LED_N          EC_GPIO_C0 // GPIOC0       | J5.29    |            | To light SCROLL LED, low active
...
#define APU_PWROK                EC_GPIO_72 // GPIO72       | J3.3     |            | Notify EC that battery is present, low active
...
#define EC_S5_PWREN              EC_GPIO_D4 // GPIOD4       | J4.1     |            | To enable system's ALWAYS power rails, high active
...
#define KBRST_N                  EC_GPIO_36 // GPIO36       | J4.5     |            | EC to Warm reset APU, low active
#define MPM_EVENT_N              EC_GPIO_73 // GPIO73       | J4.8     | GPIO33_20  | Wireless Manageability Processor interrupt, low active
#define RSMRST_N                 EC_GPIO_81 // GPIO81       | J4.7     |            | 
#define SLP_S3_S0A3_N            EC_GPIO_64 // GPIO64       | J3.13    |            | To notify EC, S3 is asserted, low active
...
#define ESPI_EC_D2               EC_GPIO_51 // eSPI_IO2     | J1.12    |            | 
...
#define SPI_APU_EC_ROM_GNT       EC_GPIO_80 // GPIO80       | J1.1     |            | SPI bus grant from APU to EC
...
#define APU_THERMTRIP_N          EC_GPIO_50 // GPIO50       | J3.5     |            | To notify EC that APU is shutdown
...
#define POR_INIT_THERMAL         \
    APU_EC_ALERT_N,               APU_THERMTRIP_N,              EC_APU_PROCHOT_N,             EC_TACH0

/*******************
 * UNUSED 
 *******************/
#define EC_ARM                   EC_GPIO_66 // GPIO66       | .        |            | 
#define GPIO32                   EC_GPIO_32 // GPIO         | .        |            | 
#define GPIO35                   EC_GPIO_35 // GPIO         | .        |            | 
#define GPIO65                   EC_GPIO_65 // GPIO         | .        |            | 
#define GPIO94                   EC_GPIO_94 // GPIO94       | .        |            | EC to reset FCH, low active.
#define GPIO95                   EC_GPIO_95 // GPIO95       | .        |            | 
#define GPIO97                   EC_GPIO_97 // GPIO97       | .        |            | To notify EC, all system power rails are ready.
#define GPIOA1                   EC_GPIO_A1 // GPIOA1       | .        |            | 
#define GPIOA3                   EC_GPIO_A3 // GPIOA3       | .        |            | 
#define GPIOA6                   EC_GPIO_A6 // GPIO         | .        |            | 
#define GPIOB0                   EC_GPIO_B0 // GPIOB0       | .        |            | 
#define GPIOB6                   EC_GPIO_B6 // GPIO         | .        |            | 
#define GPIOD6                   EC_GPIO_D6 // GPIO         | .        |            | 
#define GPIOD7                   EC_GPIO_D7 // GPIOD7       | .        |            | To notify EC, all system power rails are ready.
#define GPIOE2                   EC_GPIO_E2 // GPIO         | .        |            | 

#define POR_INIT_UNUSED          \
    EC_ARM,                       GPIO32,                       GPIO35,                       GPIO65,                       \
    GPIO94,                       GPIO95,                       GPIO97,                       GPIOA1,                       \
    GPIOA3,                       GPIOA6,                       GPIOB0,                       GPIOB6,                       \
    GPIOD6,                       GPIOD7,                       GPIOE2
...
#define GPIO_RUNTIME_SWITCH_G3                                         \
    ...
    {EC_BLINK_N,         GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,          GPIO_CTRL_PWRG_OFF         },    \
