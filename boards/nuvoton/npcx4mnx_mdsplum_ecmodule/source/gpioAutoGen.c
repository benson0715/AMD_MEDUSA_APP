 ...
 ***************************************************************************************************/
    ...
    {BAT_PRSNT_N,        GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO01      
    {EVAL_PRSNT_N_EC,    GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO02      
    {HW_LID_CLOSE_N,     GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO03      
 ...
 ***************************************************************************************************/
    ...
    {GPIO32,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
    {SYS_RST_N,          GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,                         GPIO_CTRL_PWRG_VTR_IO      },    // GPIO33      
    {EC_EVAL_BOMACO_EN,  GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_OFF         },    // GPIO34      
    {GPIO35,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
    {KBRST_N,            GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,                         GPIO_CTRL_PWRG_VTR_IO      },    // GPIO36      
    {EC_EVAL_SLT_PWREN,  GPIO_OUTPUT_LOW | GPIO_OPEN_DRAIN,                          GPIO_CTRL_PWRG_OFF         },    // GPIO37      
 ...
 ***************************************************************************************************/
    {EC_TACH0,           GPIO_INPUT,                                                 GPIO_CTRL_PWRG_OFF         },    // TA1         
    {EC_EVAL_CARD_PWREN, GPIO_OUTPUT_LOW | GPIO_OPEN_DRAIN,                          GPIO_CTRL_PWRG_OFF         },    // GPIO41      
    {AC_PRSNT_N,         GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO42      
    {EC_SD_AUX_RST_N,    GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_OFF         },    // GPIO43      
    {EC_EVAL_AUX_RST_N,  GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_OFF         },    // GPIO44      
    {EC_DT_SLT_AUX_RST_N, GPIO_OUTPUT_LOW,                                           GPIO_CTRL_PWRG_OFF         },    // GPIO45      
 ...
 ***************************************************************************************************/
    {APU_THERMTRIP_N,    GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_OFF         },    // GPIO50      
 ...
 ***************************************************************************************************/
    {EC_BLINK_N,         GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,                         GPIO_CTRL_PWRG_OFF         },    // GPIO60      
    {EC_SLP_S5_N,        GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO61      
    {EC_WWAN_AUX_RST_N,  GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_OFF         },    // GPIO62      
    {EC_WLAN_AUX_RST_N,  GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_OFF         },    // GPIO63      
    {SLP_S3_S0A3_N,      GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO64      
    {GPIO65,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
    {EC_ARM,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO66      
    {EC_TPAD_TYP_GUARD_N, GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,                        GPIO_CTRL_PWRG_VTR_IO      },    // GPIO67      
 ...
 * GPIO76/PIO         EC_SCI#            ------------       ------------       ------------       ------------       ------------      
 ***************************************************************************************************/
    {EC_TPAD_KB_BLON_N,  GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,                         GPIO_CTRL_PWRG_VTR_IO      },    // GPIO70      
    {APU_PWROK,          GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO72      
 ...
 ***************************************************************************************************/
    {SPI_APU_EC_ROM_GNT, GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_OFF         },    // GPIO80      
    {RSMRST_N,           GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO81      
 ...
 ***************************************************************************************************/
    ...
    {SPI_EC_ROM_D2,      GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // FLM_DI2     
    {GPIO94,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO94      
    {GPIO95,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO95      
    {SPI_EC_ROM_D1,      GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // FLM_DI1     
    {GPIO97,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO97      
 ...
 ***************************************************************************************************/
    ...
    {GPIOA6,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
    {SPI_EC_ROM_D3,      GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // FLM_DI3     
 ...
 ***************************************************************************************************/
    {GPIOB0,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIOB0      
    {EVAL_PWRGD,         GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIOB1      
    ...
    {GPIOB6,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
    {EC_NUM_LED_N,       GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,                         GPIO_CTRL_PWRG_VTR_IO      },    // GPIOB7      
 ...
 ***************************************************************************************************/
    {EC_SCROLL_LED_N,    GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,                         GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC0      
    {EC_APU_PROCHOT_N,   GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,                         GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC1      
    {EC_CAP_LED_N,       GPIO_OUTPUT_LOW | GPIO_OPEN_DRAIN,                          GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC2      
    {EP_EC_INT_N,        GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC3      
    {EC_SLT_PWRBRK_N,    GPIO_OUTPUT_HIGH | GPIO_OPEN_DRAIN,                         GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC4      
    {SYSTEM_S5_PG,       GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC5      
    {EC_EVAL_19V_PWREN,  GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_OFF         },    // GPIOC6      
    {PD1_EC_USBC_INT_N,  GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC7      
 ...
 ***************************************************************************************************/
    ...
    {EC_AC_PD_N,         GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOD3      
    {EC_S5_PWREN,        GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOD4      
    {EC_JTAG_TCK_SWCLK,  GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
    {GPIOD6,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
 ...
 ***************************************************************************************************/
    ...
    {EC_ADC_RSVD,        GPIO_INPUT,                                                 GPIO_CTRL_PWRG_OFF         },    // GPIO        
    {GPIOE2,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
    {HDR_DOCK_IN_N,      GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIOE3      
    {EC_1V8_S5_EN,       GPIO_OUTPUT_HIGH,                                           GPIO_CTRL_PWRG_VTR_IO      },    // GPIOE4      
    {EC_JTAG_TMS_SWIO,   GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
 ...
 ***************************************************************************************************/
    ...
    {EC_LOM_AUX_RST_N,   GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_OFF         },    // GPIOF1      
    {EC_UDC_UART_INT_N,  GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOF2      
    ...
    {GPIOF5,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO        
 ...
 *
 * Configures all application-owned GPIOs defined in AMDNPCX4_CFG array.
 *
...
/**
 * @brief Runtime GPIO switching based on system power state
 *
 * Reconfigures GPIOs when system transitions between power states.
 *
 ...
 *
 * Handles read/write operations for GPIO bank at ACPI_GPIO_BASE + 3.
 *
...
void __autogen_AcpiHandler_GIO0(uint8_t isRead, uint8_t ui8Idx, uint8_t *pui8Data)
{
    ...
    if (isRead) {
        retVal |= gpio_read_pin(AC_PRSNT_N)           ? 0x01 : 0x00;
        retVal |= gpio_read_pin(EVAL_PWRGD)           ? 0x02 : 0x00;
        retVal |= gpio_read_pin(EVAL_PRSNT_N_EC)      ? 0x04 : 0x00;
        retVal |= gpio_read_pin(EC_TPAD_TYP_GUARD_N)  ? 0x08 : 0x00;
        retVal |= gpio_read_pin(PD_PRSNT_N)           ? 0x10 : 0x00;
        retVal |= gpio_read_pin(CHG_EC_PROCHOT_N)     ? 0x20 : 0x00;
        retVal |= gpio_read_pin(APU_EC_ALERT_N)       ? 0x40 : 0x00;
        retVal |= gpio_read_pin(SYSTEM_S5_PG)         ? 0x80 : 0x00;
        ...
        gpio_write_pin(AC_PRSNT_N,          (retVal & 0x01) ? 1 : 0);
        gpio_write_pin(EVAL_PWRGD,          (retVal & 0x02) ? 1 : 0);
        gpio_write_pin(EVAL_PRSNT_N_EC,     (retVal & 0x04) ? 1 : 0);
        gpio_write_pin(EC_TPAD_TYP_GUARD_N, (retVal & 0x08) ? 1 : 0);
        gpio_write_pin(PD_PRSNT_N,          (retVal & 0x10) ? 1 : 0);
        gpio_write_pin(CHG_EC_PROCHOT_N,    (retVal & 0x20) ? 1 : 0);
        gpio_write_pin(APU_EC_ALERT_N,      (retVal & 0x40) ? 1 : 0);
        gpio_write_pin(SYSTEM_S5_PG,        (retVal & 0x80) ? 1 : 0);
    }
}
 ...
 *
 * Handles read/write operations for GPIO bank at ACPI_GPIO_BASE + 4.
 *
 * @param isRead Non-zero for read operation, zero for write
 * @param ui8Idx ACPI register index
 * @param pui8Data Pointer to data buffer
...
void __autogen_AcpiHandler_GIO1(uint8_t isRead, uint8_t ui8Idx, uint8_t *pui8Data)
{
    ...
    if (isRead) {
        retVal |= gpio_read_pin(EC_TPAD_KB_BLON_N)    ? 0x01 : 0x00;
        retVal |= gpio_read_pin(EC_EVAL_CARD_PWREN)   ? 0x02 : 0x00;
        ...
        gpio_write_pin(EC_TPAD_KB_BLON_N,   (retVal & 0x01) ? 1 : 0);
        gpio_write_pin(EC_EVAL_CARD_PWREN,  (retVal & 0x02) ? 1 : 0);
    }
}
 ...
 *
 * Handles read/write operations for GPIO bank at ACPI_GPIO_BASE + 5.
 *
 * @param isRead Non-zero for read operation, zero for write
 * @param ui8Idx ACPI register index
 * @param pui8Data Pointer to data buffer
...
void __autogen_AcpiHandler_GIO2(uint8_t isRead, uint8_t ui8Idx, uint8_t *pui8Data)
{
    ...
    if (isRead) {
        retVal |= gpio_read_pin(EC_SLT_PWRBRK_N)      ? 0x01 : 0x00;
        retVal |= gpio_read_pin(EC_EVAL_19V_PWREN)    ? 0x04 : 0x00;
        retVal |= gpio_read_pin(EC_EVAL_SLT_PWREN)    ? 0x20 : 0x00;
        retVal |= gpio_read_pin(EC_EVAL_BOMACO_EN)    ? 0x40 : 0x00;
        ...
        gpio_write_pin(EC_SLT_PWRBRK_N,     (retVal & 0x01) ? 1 : 0);
        gpio_write_pin(EC_EVAL_19V_PWREN,   (retVal & 0x04) ? 1 : 0);
        gpio_write_pin(EC_EVAL_SLT_PWREN,   (retVal & 0x20) ? 1 : 0);
        gpio_write_pin(EC_EVAL_BOMACO_EN,   (retVal & 0x40) ? 1 : 0);
    }
}
 ...
 *
 * Handles read/write operations for GPIO bank at ACPI_GPIO_BASE + 6.
 *
 * @param isRead Non-zero for read operation, zero for write
 * @param ui8Idx ACPI register index
 * @param pui8Data Pointer to data buffer
...
void __autogen_AcpiHandler_GIO3(uint8_t isRead, uint8_t ui8Idx, uint8_t *pui8Data)
{
    ...
    if (isRead) {
        retVal |= gpio_read_pin(EC_EVAL_AUX_RST_N)    ? 0x01 : 0x00;
        retVal |= gpio_read_pin(EC_LOM_AUX_RST_N)     ? 0x02 : 0x00;
        retVal |= gpio_read_pin(EC_DT_SLT_AUX_RST_N)  ? 0x04 : 0x00;
        retVal |= gpio_read_pin(EC_SD_AUX_RST_N)      ? 0x08 : 0x00;
        retVal |= gpio_read_pin(EC_WWAN_AUX_RST_N)    ? 0x10 : 0x00;
        retVal |= gpio_read_pin(EC_WLAN_AUX_RST_N)    ? 0x20 : 0x00;
        ...
        gpio_write_pin(EC_EVAL_AUX_RST_N,   (retVal & 0x01) ? 1 : 0);
        gpio_write_pin(EC_LOM_AUX_RST_N,    (retVal & 0x02) ? 1 : 0);
        gpio_write_pin(EC_DT_SLT_AUX_RST_N, (retVal & 0x04) ? 1 : 0);
        gpio_write_pin(EC_SD_AUX_RST_N,     (retVal & 0x08) ? 1 : 0);
        gpio_write_pin(EC_WWAN_AUX_RST_N,   (retVal & 0x10) ? 1 : 0);
        gpio_write_pin(EC_WLAN_AUX_RST_N,   (retVal & 0x20) ? 1 : 0);
    }
}
 ...
 *
 * Handles read/write operations for GPIO bank at ACPI_GPIO_BASE + 7.
 *
 * @param isRead Non-zero for read operation, zero for write
 * @param ui8Idx ACPI register index
 * @param pui8Data Pointer to data buffer
...
void __autogen_AcpiHandler_GIO4(uint8_t isRead, uint8_t ui8Idx, uint8_t *pui8Data)
{
    ...
    if (isRead) {
        retVal |= gpio_read_pin(CHG_ACOK)             ? 0x01 : 0x00;
        retVal |= gpio_read_pin(HW_LID_CLOSE_N)       ? 0x02 : 0x00;
        retVal |= gpio_read_pin(HDR_DOCK_IN_N)        ? 0x04 : 0x00;
        retVal |= gpio_read_pin(BAT_PRSNT_N)          ? 0x08 : 0x00;
        ...
        gpio_write_pin(CHG_ACOK,            (retVal & 0x01) ? 1 : 0);
        gpio_write_pin(HW_LID_CLOSE_N,      (retVal & 0x02) ? 1 : 0);
        gpio_write_pin(HDR_DOCK_IN_N,       (retVal & 0x04) ? 1 : 0);
        gpio_write_pin(BAT_PRSNT_N,         (retVal & 0x08) ? 1 : 0);
    }
}

/**
 * @brief Main board GPIO ACPI handler
 *
 * Dispatches ACPI GPIO read/write requests to appropriate handler functions.
 *
 * @param isRead Non-zero for read operation, zero for write
 * @param ui8Idx ACPI register index
 * @param pui8Data Pointer to data buffer
