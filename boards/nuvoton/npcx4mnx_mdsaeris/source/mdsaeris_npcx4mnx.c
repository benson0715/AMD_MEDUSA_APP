...
int board_init(void)
{
	...
	/* need to turn off the JTAG before GPIO init */
...
/**
 * @brief Callback when APU power is OK
 *
...
/**
 * @brief Evaluate card control pins
 *
 * PLAT-84470
