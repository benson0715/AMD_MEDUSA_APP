...
#define EC_VERSION_STRING_1_VALUE     "MDS_AERIS_"         /* 0x200A: 10-bytes */
#define EC_VERSION_STRING_2_VALUE     "2026-03-05"         /* 0x2014: 10-bytes */
#define EC_VERSION_STRING_3_VALUE     "0.0.3"              /* 0x201E:  5-bytes */
#define EC_VERSION_STRING_4_VALUE     "7321 "              /* 0x2023:  5-bytes */
#define EC_VERSION_STRING_5_VALUE     "6576049*"           /* 0x2028:  Repository Version; Local changes flag(*|.) */
#define EC_VERSION_STRING_6_VALUE     "151911"             /*          Build time */
#define EC_VERSION_STRING_7_VALUE     "e5daae84c5043bff547bc3eff1db9385a81d864a" /* VERSION SHA1SUM */
#define EC_VERSION_U32_MAGIC          0x9953C841ul         /* uint32_t magic of SHA1SUM */
