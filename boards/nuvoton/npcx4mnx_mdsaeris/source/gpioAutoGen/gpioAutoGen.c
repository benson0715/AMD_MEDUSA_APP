 ...
 ***************************************************************************************************/
    ...
    {EC_SENSOR_1V8_PWREN, GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO03      
 ...
 ***************************************************************************************************/
    ...
    {EC_FN_LED,          GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO34      
    {GPIO35,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO35      
    {GPIO36,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO36      
    {EC_M2_BT_WAKE,      GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO37      
 ...
 ***************************************************************************************************/
    ...
    {EC_CHG_WHITE_LED,   GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO43      
    {EC_TPM_PWREN,       GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO44      
    {GPIO45,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO45      
 ...
 ***************************************************************************************************/
    {EC_WLAN_WIFI_RST,   GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO60      
    {EC_SLP_S5_N,        GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO61      
    {TPNL_EN_CONN,       GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO62      
    {EC_WLAN_AUX_RST_N,  GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_OFF         },    // GPIO63      
    {EC_USBCAM_PWREN,    GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO64      
    {GPIO65,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO65      
    {EC_ARM,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO66      
    {BOARD_ID0,          GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO67      
 ...
 * GPIO76/PIO         EC_SCI#            ------------       ------------       ------------       ------------       ------------      
 ***************************************************************************************************/
    {BOARD_ID1,          GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIO70      
 ...
 ***************************************************************************************************/
    ...
    {EC_APU_PCC_N,       GPIO_OUTPUT_HIGH,                                           GPIO_CTRL_PWRG_VTR_IO      },    // GPIO81      
 ...
 ***************************************************************************************************/
    ...
    {EC_WLAN_I2C_ALERT_N_1V8, GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIO95      
 ...
 ***************************************************************************************************/
    ...
    {ALS_INT_N,          GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOA1      
    {SPI_EC_ROM_CLK,     GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // FLM_SCLK    
    {SFH_EC_INT_N_R,     GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOA3      
 ...
 ***************************************************************************************************/
    {EC_CODEC_DEPOP_MUTE_N, GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOB0      
    {EC_SSD0_PWREN,      GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOB1      
 ...
 ***************************************************************************************************/
    {EC_WLAN_RASIO_DIS,  GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC0      
    ...
    {EC_TPAD_PWREN,      GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC4      
    {SYSTEM_S5_PG,       GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC5      
    {EC_USBC_RT_SMB_BUFF_EN, GPIO_OUTPUT_LOW | GPIO_OPEN_DRAIN,                          GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC6      
    {EC_BT_RADIO_DIS,    GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOC7      
 ...
 ***************************************************************************************************/
    ...
    {GPIOD3,             GPIO_INPUT,                                                 GPIO_CTRL_PWRG_VTR_IO      },    // GPIOD3      
    {EC_USBCAM_FW_WP_N,  GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOD4      
    {WLAN_PWREN,         GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOD5      
 ...
 ***************************************************************************************************/
    ...
    {EC_TPNL_PWREN,      GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOE1      
    {EC_USBCAM_PRIV,     GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOE2      
    {EC_S5_PWREN,        GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOE3      
    {EC_1V8_S5_EN,       GPIO_OUTPUT_HIGH,                                           GPIO_CTRL_PWRG_VTR_IO      },    // GPIOE4      
    {EC_FPR_PWREN,       GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOE5      
 ...
 ***************************************************************************************************/
    {EC_DMIC_PWREN,      GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOF0      
    {EC_S0_LED,          GPIO_OUTPUT_LOW,                                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOF1      
    {PD1_EC_USBC_INT_N,  GPIO_INPUT | GPIO_INT_EDGE_BOTH,                            GPIO_CTRL_PWRG_VTR_IO      },    // GPIOF2      
 ...
 *
 * @param pwr_state Current system power state
 */
...
/**
 * @brief ACPI handler for GPIO group 0
 *
 * @param isRead Read operation flag
 * @param ui8Idx ACPI index
...
void __autogen_AcpiHandler_GIO0(uint8_t isRead, uint8_t ui8Idx, uint8_t *pui8Data)
{
    ...
    if (isRead) {
        ...
        retVal |= gpio_read_pin( EC_DMIC_PWREN )        ? 0x10 : 0x00;	// GPIOF0/AD9
        ...
        gpio_write_pin( EC_DMIC_PWREN ,       (retVal & 0x10) ? 1 : 0 );	// GPIOF0/AD9
...
/**
 * @brief ACPI handler for GPIO group 1
 *
 * @param isRead Read operation flag
 * @param ui8Idx ACPI index
 * @param pui8Data Pointer to data buffer
...
void __autogen_AcpiHandler_GIO1(uint8_t isRead, uint8_t ui8Idx, uint8_t *pui8Data)
{
    ...
    if (isRead) {
        ...
        retVal |= gpio_read_pin( EC_SSD0_PWREN )        ? 0x02 : 0x00;	// KSO17/GPIOB1/CR_SIN4
        retVal |= gpio_read_pin( EC_CODEC_DEPOP_MUTE_N ) ? 0x08 : 0x00;	// GPIOB0
        retVal |= gpio_read_pin( EC_APU_PCC_N )         ? 0x10 : 0x00;	// PECI_DATA/GPIO81
        ...
        gpio_write_pin( EC_SSD0_PWREN ,       (retVal & 0x02) ? 1 : 0 );	// KSO17/GPIOB1/CR_SIN4
        gpio_write_pin( EC_CODEC_DEPOP_MUTE_N ,(retVal & 0x08) ? 1 : 0 );	// GPIOB0
        gpio_write_pin( EC_APU_PCC_N ,        (retVal & 0x10) ? 1 : 0 );	// PECI_DATA/GPIO81
    }
}

/**
 * @brief ACPI handler for GPIO group 2
 *
 * @param isRead Read operation flag
 * @param ui8Idx ACPI index
 * @param pui8Data Pointer to data buffer
...
void __autogen_AcpiHandler_GIO2(uint8_t isRead, uint8_t ui8Idx, uint8_t *pui8Data)
{
    ...
    if (isRead) {
        retVal |= gpio_read_pin( EC_TPNL_PWREN )        ? 0x01 : 0x00;	// GPIOE1/AD7
        retVal |= gpio_read_pin( EC_BT_RADIO_DIS )      ? 0x02 : 0x00;	// GPIOC7/DTR_BOUT/AD11
        retVal |= gpio_read_pin( EC_USBC_RT_SMB_BUFF_EN ) ? 0x04 : 0x00;	// GPIOC6/SMI#
        retVal |= gpio_read_pin( EC_USBCAM_PWREN )      ? 0x08 : 0x00;	// GPIO64/CR_SIN1
        retVal |= gpio_read_pin( EC_TPAD_PWREN )        ? 0x10 : 0x00;	// GPIOC4/PWM2
        retVal |= gpio_read_pin( EC_M2_BT_WAKE )        ? 0x20 : 0x00;	// GPIO37/PS2_CLK2/AD5
        retVal |= gpio_read_pin( SFH_EC_INT_N_R )       ? 0x80 : 0x00;	// SPIP_MOS/GPIOA3
        ...
        gpio_write_pin( EC_TPNL_PWREN ,       (retVal & 0x01) ? 1 : 0 );	// GPIOE1/AD7
        gpio_write_pin( EC_BT_RADIO_DIS ,     (retVal & 0x02) ? 1 : 0 );	// GPIOC7/DTR_BOUT/AD11
        gpio_write_pin( EC_USBC_RT_SMB_BUFF_EN ,(retVal & 0x04) ? 1 : 0 );	// GPIOC6/SMI#
        gpio_write_pin( EC_USBCAM_PWREN ,     (retVal & 0x08) ? 1 : 0 );	// GPIO64/CR_SIN1
        gpio_write_pin( EC_TPAD_PWREN ,       (retVal & 0x10) ? 1 : 0 );	// GPIOC4/PWM2
        gpio_write_pin( EC_M2_BT_WAKE ,       (retVal & 0x20) ? 1 : 0 );	// GPIO37/PS2_CLK2/AD5
        gpio_write_pin( SFH_EC_INT_N_R ,      (retVal & 0x80) ? 1 : 0 );	// SPIP_MOS/GPIOA3
    }
}

/**
 * @brief ACPI handler for GPIO group 3
 *
 * @param isRead Read operation flag
 * @param ui8Idx ACPI index
 * @param pui8Data Pointer to data buffer
...
void __autogen_AcpiHandler_GIO3(uint8_t isRead, uint8_t ui8Idx, uint8_t *pui8Data)
{
    ...
    if (isRead) {
        retVal |= gpio_read_pin( EC_FPR_PWREN )         ? 0x01 : 0x00;	// GPIOE5/JTAG_TMS1_SWIO1
        retVal |= gpio_read_pin( EC_SENSOR_1V8_PWREN )  ? 0x02 : 0x00;	// KSO16/GPIO03
        retVal |= gpio_read_pin( EC_WLAN_WIFI_RST )     ? 0x04 : 0x00;	// GPIO60/PWM7
        retVal |= gpio_read_pin( TPNL_EN_CONN )         ? 0x10 : 0x00;	// GPIO62/PS2_CLK1/AD16
        retVal |= gpio_read_pin( EC_WLAN_AUX_RST_N )    ? 0x20 : 0x00;	// GPIO63/PS2_DAT1/AD17/INTRUDER2#
        retVal |= gpio_read_pin( EC_TPM_PWREN )         ? 0x40 : 0x00;	// GPIO44/AD1
        ...
        gpio_write_pin( EC_FPR_PWREN ,        (retVal & 0x01) ? 1 : 0 );	// GPIOE5/JTAG_TMS1_SWIO1
        gpio_write_pin( EC_SENSOR_1V8_PWREN , (retVal & 0x02) ? 1 : 0 );	// KSO16/GPIO03
        gpio_write_pin( EC_WLAN_WIFI_RST ,    (retVal & 0x04) ? 1 : 0 );	// GPIO60/PWM7
        gpio_write_pin( TPNL_EN_CONN ,        (retVal & 0x10) ? 1 : 0 );	// GPIO62/PS2_CLK1/AD16
        gpio_write_pin( EC_WLAN_AUX_RST_N ,   (retVal & 0x20) ? 1 : 0 );	// GPIO63/PS2_DAT1/AD17/INTRUDER2#
        gpio_write_pin( EC_TPM_PWREN ,        (retVal & 0x40) ? 1 : 0 );	// GPIO44/AD1
        gpio_write_pin( EC_CODEC_MIC_HW_MUTE_N ,(retVal & 0x80) ? 1 : 0 );	// GPIOA6/PS2_CLK3/TA2/F_CS1#
    }
}

/**
 * @brief ACPI handler for GPIO group 4
 *
 * @param isRead Read operation flag
 * @param ui8Idx ACPI index
 * @param pui8Data Pointer to data buffer
...
void __autogen_AcpiHandler_GIO4(uint8_t isRead, uint8_t ui8Idx, uint8_t *pui8Data)
{
    ...
    if (isRead) {
        ...
        retVal |= gpio_read_pin( EC_WLAN_RASIO_DIS )    ? 0x10 : 0x00;	// GPIOC0/PWM6/I2C7_SCL1/S_SBUA
        retVal |= gpio_read_pin( EC_USBCAM_FW_WP_N )    ? 0x20 : 0x00;	// GPIOD4/CR_SIN3/JTAG_TDO1_SWO1
        retVal |= gpio_read_pin( WLAN_PWREN )           ? 0x40 : 0x00;	// GPIOD5/INTRUDER1#/JTAG_TCK1_SWCLK1
        retVal |= gpio_read_pin( EC_USBCAM_PRIV )       ? 0x80 : 0x00;	// GPIOE2/JTAG_TDI1
        ...
        gpio_write_pin( EC_WLAN_RASIO_DIS ,   (retVal & 0x10) ? 1 : 0 );	// GPIOC0/PWM6/I2C7_SCL1/S_SBUA
        gpio_write_pin( EC_USBCAM_FW_WP_N ,   (retVal & 0x20) ? 1 : 0 );	// GPIOD4/CR_SIN3/JTAG_TDO1_SWO1
        gpio_write_pin( WLAN_PWREN ,          (retVal & 0x40) ? 1 : 0 );	// GPIOD5/INTRUDER1#/JTAG_TCK1_SWCLK1
        gpio_write_pin( EC_USBCAM_PRIV ,      (retVal & 0x80) ? 1 : 0 );	// GPIOE2/JTAG_TDI1
    }
}

/**
 * @brief Board GPIO ACPI handler dispatcher
 *
 * @param isRead Read operation flag
 * @param ui8Idx ACPI index
 * @param pui8Data Pointer to data buffer
