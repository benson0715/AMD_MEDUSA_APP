...
#ifndef AMD_CRB_DRIVERS_TPS6599X_H_
#define AMD_CRB_DRIVERS_TPS6599X_H_
...
#define TIPD_REG_PWR_STATUS                         (0x3F)
...
#define TIPD_REG_MIPI_VID_CONFIG                    (0x4B)

#define TIPD_REG_RX_ATT                             (0x4E)
#define TIPD_REG_RX_VDM                             (0x4F)
#define TIPD_REG_DATA_CTL                           (0x50)
...
#define TIPD_REG_GPIO_CONFIG                        (0x5C)
...
#define TIPD_REG_GL_SYS_CONFIG_LEN                   (10) /* 0x27 */
#define TIPD_REG_PORT_CONFIG_LEN                     (3)  /* 0x28 */
#define TIPD_REG_PORT_CTL_LEN                        (4)  /* 0x29 */

#define TIPD_REG_BOOT_STATUS_LEN                     (5)  /* 0x2D */
#define TIPD_REG_BUILD_DES_LEN                       (49) /* 0x2E */
#define TIPD_REG_DEV_INFO_LEN                        (40) /* 0x2F */
#define TIPD_REG_RX_SRC_CAP_LEN                      (29) /* 0x30 */
#define TIPD_REG_RX_SINK_CAP_LEN                     (29) /* 0x31 */
#define TIPD_REG_TX_SRC_CAP_LEN                      (31) /* 0x32 */
#define TIPD_REG_TX_SINK_CAP_LEN                     (29) /* 0x33 */
#define TIPD_REG_ACTIVE_PDO_LEN                      (6)  /* 0x34 */
#define TIPD_REG_ACTIVE_RDO_LEN                      (4)  /* 0x35 */
#define TIPD_REG_AUTO_NEG_SINK_LEN                   (16) /* 0x37 */

#define TIPD_REG_PWR_STATUS_LEN                      (2)  /* 0x3F */
#define TIPD_REG_PD_STATUS_LEN                       (4)  /* 0x40 */
#define TIPD_REG_PD_30_STATUS_LEN                    (4)  /* 0x41 */
#define TIPD_REG_PD_30_CONFIG_LEN                    (3)  /* 0x42 */
#define TIPD_REG_DELAY_CONFIG_LEN                    (12) /* 0x43 */

#define TIPD_REG_TX_IDENTITY_LEN                     (13) /* 0x47 */
...
#define TIPD_REG_MIPI_VID_CONFIG_LEN                 (4)  /* 0x4B */

#define TIPD_REG_RX_ATT_LEN                          (9)  /* 0x4E */
#define TIPD_REG_RX_VDM_LEN                          (29) /* 0x4F */
#define TIPD_REG_DATA_CTL_LEN                        (6)  /* 0x50 */
#define TIPD_REG_DP_SID_CONFIG_LEN                   (6)  /* 0x51 */
#define TIPD_REG_INTEL_VID_CONFIG_LEN                (7)  /* 0x52 */
...
#define TIPD_REG_GPIO_CONFIG_LEN                     (49) /* 0x5C */
...
#define TIPD_EVENT2_I2C_MASTER_NAK                   (1 << 18)
...
#define DRV_TPS6599X_INT_EVENT_REGISTER_LENGTH       (11)  /* 0x14, 0x15, 0x16, 0x17 */
#define DRV_TPS6599X_STATUS_REGISTER_LENGTH          (5)   /* 0x1A */
#define DRV_TPS6599X_SET_SX_APP_REGISTER_LENGTH      (2)   /* 0x20 */
#define DRV_TPS6599X_RX_SVID_SOP_REGISTER_LENGTH     (9)   /* 0x21 only read 8 bytes */
#define DRV_TPS6599X_USB_CONFIG_REGISTER_LENGTH      (4)   /* 0x23 */
#define DRV_TPS6599X_POWER_PATH_REGISTER_LENGTH      (5)   /* 0x26 */
#define DRV_TPS6599X_PORT_CONFIG_REGISTER_LENGTH     (3)   /* 0x28 */
#define DRV_TPS6599X_PORT_CONTROL_REGISTER_LENGTH    (4)   /* 0x29 */
#define DRV_TPS6599X_BOOT_FLAGS_REGISTER_LENGTH      (4)   /* 0x2D only read first 4 of 5 */
#define DRV_TPS6599X_DEV_INFO_REGISTER_LENGTH        (40)  /* 0x2F */
#define DRV_TPS6599X_RX_SRC_CAP_REGISTER_LENGTH      (29)  /* 0x30 */
#define DRV_TPS6599X_RX_SNK_CAP_REGISTER_LENGTH      (29)  /* 0x31 */
#define DRV_TPS6599X_TX_SRC_CAP_REGISTER_LENGTH      (31)  /* 0x32 */
#define DRV_TPS6599X_TX_SNK_CAP_REGISTER_LENGTH      (29)  /* 0x33 */
#define DRV_TPS6599X_PWR_STATUS_REGISTER_LENGTH      (2)   /* 0x3F */
#define DRV_TPS6599X_PD_STATUS_REGISTER_LENGTH       (4)   /* 0x40 */
#define DRV_TPS6599X_TX_VID_REGISTER_LENGTH          (25)  /* 0x47 */
#define DRV_TPS6599X_RX_VID_SOP_REGISTER_LENGTH      (25)  /* 0x48 */
#define DRV_TPS6599X_RX_VID_SOPP_REGISTER_LENGTH     (25)  /* 0x49 */
#define DRV_TPS6599X_RX_VDM_REGISTER_LENGTH          (29)  /* 0x4F */
#define DRV_TPS6599X_DATA_CTRL_REGISTER_LENGTH       (1)   /* 0x50 Only read/write first 1 byte of 6 */
#define DRV_TPS6599X_INTEL_VID_CF_REGISTER_LENGTH    (7)   /* 0x52 */
#define DRV_TPS6599X_GPIO_CONFIG_REGISTER_LENGTH     (12)  /* 0x5C Only read/write 1~12 bytes for GPIO_OE (total length 49)*/
#define DRV_TPS6599X_DATA_STATUS_REGISTER_LENGTH     (5)   /* 0x5F */
#define DRV_TPS6599X_SLEEP_CONFIG_REGISTER_LENGTH    (1)   /* 0x70 */
#define DRV_TPS6599X_GPIO_STATUS_REGISTER_LENGTH     (8)   /* 0x72 */


#define DRV_TPS_INT_EVENT      DRV_TPS6599X_INT_EVENT
...
{    
    ...
    union {
        struct {
		    ...
		    uint8_t  I2cMasterNACKed                       :1;
            uint8_t  Rsvd27                                :5;
        } PACK_STRUCT f;
        uint8_t buf[DRV_TPS6599X_INT_EVENT_REGISTER_LENGTH];
    };
} DRV_TPS6599X_INT_EVENT;

#define DRV_TPS_STATUS     DRV_TPS6599X_STATUS
...
typedef struct {
    ...
    union {
        ...
        uint8_t buf[DRV_TPS6599X_STATUS_REGISTER_LENGTH];
    };
} DRV_TPS6599X_STATUS;

#define DRV_TPS_SET_SX_APP_CONFIG  DRV_TPS6599X_SET_SX_APP_CONFIG
...
{    
    ...
    union {
        ...
        uint8_t buf[DRV_TPS6599X_SET_SX_APP_REGISTER_LENGTH];
    };
} DRV_TPS6599X_SET_SX_APP_CONFIG;

#define DRV_TPS_RX_SVID_SOP   DRV_TPS6599X_RX_SVID_SOP
...
{    
    ...
    union {
        ...
        uint8_t buf[DRV_TPS6599X_RX_SVID_SOP_REGISTER_LENGTH];
    };
} DRV_TPS6599X_RX_SVID_SOP;
...
{    
    ...
    union {
        ...
        uint8_t buf[DRV_TPS6599X_USB_CONFIG_REGISTER_LENGTH];
    };
} DRV_TPS6599X_USB_CONFIG;

#define DRV_TPS_POWER_PATH   DRV_TPS6599X_POWER_PATH
...
{    
    ...
    union {
        ...
        uint8_t buf[DRV_TPS6599X_POWER_PATH_REGISTER_LENGTH];
    };
} DRV_TPS6599X_POWER_PATH;

#define DRV_TPS_PORT_CONFIG   DRV_TPS6599X_PORT_CONFIG

/* length->2 address->0x28 */
typedef struct
{    
    uint8_t u8Length;
    union {
        ...
        uint8_t buf[DRV_TPS6599X_PORT_CONFIG_REGISTER_LENGTH];
    };
} DRV_TPS6599X_PORT_CONFIG;

#define DRV_TPS_PORT_CONTROL DRV_TPS6599X_PORT_CONTROL

/* length->4 address->0x29 */
typedef struct
{    
    uint8_t u8Length;
    union {
        ...
        uint8_t buf[DRV_TPS6599X_PORT_CONTROL_REGISTER_LENGTH];
    };
} DRV_TPS6599X_PORT_CONTROL;

#define DRV_TPS_BOOT     DRV_TPS6599X_BOOT_FLAGS

/* length->4 address->0x2D */
typedef struct
{    
    uint8_t u8Length;
    union {
        struct {
            /* bytes 1-4 */
            uint32_t PatchHeaderErr                         :1;
            uint32_t Rsvd1                                  :1;
            uint32_t DeadBatteryFlag                        :1;
            uint32_t I2cEepromPresent                       :1;
            uint32_t Region0                                :1;
            uint32_t Region1                                :1;
            uint32_t Region0Invalid                         :1;
            uint32_t Region1Invalid                         :1;
            uint32_t region0eepromerr                       :1;
            uint32_t region1eepromerr                       :1;
            uint32_t PatchDownloadErr                       :1;
            uint32_t Rsvd11                                 :1;
            uint32_t Region0CrcFail                         :1;
            uint32_t Region1CrcFail                         :1;
            uint32_t Rsvd14                                 :1;
            uint32_t Rsvd15                                 :1;
            uint32_t Rsvd16                                 :1;
            uint32_t Pp3Switch                              :1;
            uint32_t Pp4Switch                              :1;
            uint32_t MasterTSD                              :1;
            uint32_t Rsvd2028                               :9;
            uint32_t PatchConfigSource                      :3;
        } PACK_STRUCT f;
        uint8_t buf[DRV_TPS6599X_BOOT_FLAGS_REGISTER_LENGTH];
    };
} DRV_TPS6599X_BOOT_FLAGS;

#define DRV_TPS_DEV_INFO   DRV_TPS6599X_DEV_INFO

/* length->40 address->0x2F */
typedef struct
{    
    uint8_t u8Length;
    uint8_t buf[DRV_TPS6599X_DEV_INFO_REGISTER_LENGTH];
	
} DRV_TPS6599X_DEV_INFO;

#define DRV_TPS_RX_SRC_CAP  DRV_TPS6599X_RX_SRC_CAP

/* length->29 address->0x30 */
typedef struct
{    
    uint8_t u8Length;
    union {
        ...
        uint8_t buf[DRV_TPS6599X_RX_SRC_CAP_REGISTER_LENGTH];
    };
} DRV_TPS6599X_RX_SRC_CAP;

#define DRV_TPS_RX_SNK_CAP   DRV_TPS6599X_RX_SNK_CAP

/* length->29 address->0x31 */
typedef struct
{    
    uint8_t u8Length;
    union {
        ...
        uint8_t buf[DRV_TPS6599X_RX_SNK_CAP_REGISTER_LENGTH];
    };
} DRV_TPS6599X_RX_SNK_CAP;

#define DRV_TPS_TX_SRC_CAP   DRV_TPS6599X_TX_SRC_CAP

/* length->31 address->0x32 */
typedef struct
{    
    uint8_t u8Length;
    union {
        struct {
            ...
            uint16_t PowerPathForPdo2                       :2;
            uint16_t PowerPathForPdo3                       :2;
            uint16_t PowerPathForPdo4                       :2;
            uint16_t PowerPathForPdo5                       :2;
            uint16_t PowerPathForPdo6                       :2;
            uint16_t PowerPathForPdo7                       :2;
            uint16_t Rsvd1415                               :2;
            /* bytes 4-7 */
        ...
        uint8_t buf[DRV_TPS6599X_TX_SRC_CAP_REGISTER_LENGTH];
    };
} DRV_TPS6599X_TX_SRC_CAP;

#define DRV_TPS_TX_SNK_CAP   DRV_TPS6599X_TX_SNK_CAP

/* length->29 address->0x33 */
typedef struct
{    
    uint8_t u8Length;
    union {
        ...
        uint8_t buf[DRV_TPS6599X_TX_SNK_CAP_REGISTER_LENGTH];
    };
} DRV_TPS6599X_TX_SNK_CAP;

#define DRV_TPS_PWR_STATUS   DRV_TPS6599X_PWR_STATUS

/* length->2 address->0x3F */
typedef struct
{    
    uint8_t u8Length;
    union {
        struct {
            /* bytes 1-2 */
            uint16_t PowerConnection                        :1;
            uint16_t SourceSink                            	:1;
            uint16_t Type_C_Current                         :2;
            uint16_t Charger_Detect_Status                  :4;
            uint16_t Charger_Advertise_Status               :2;
            uint16_t Rsvd7                                  :6;
        } PACK_STRUCT f;
        uint8_t buf[DRV_TPS6599X_PWR_STATUS_REGISTER_LENGTH];
    };
} DRV_TPS6599X_PWR_STATUS;

#define DRV_TPS_PD_STATUS   DRV_TPS6599X_PD_STATUS
...
{    
    ...
    union {
        ...
        uint8_t buf[DRV_TPS6599X_PD_STATUS_REGISTER_LENGTH];
    };
} DRV_TPS6599X_PD_STATUS;

#define DRV_TPS_TX_VID   DRV_TPS6599X_TX_VID

/* length->25 address->0x47 */
typedef struct
{    
    uint8_t u8Length;
    union {
        struct {
            ...
            /* bytes 14-17 */
            uint32_t ProductTypeVdo0SOP                     :32;
            /* bytes 18-21 */
            uint32_t ProductTypeVdo1SOP                     :32;
            /* bytes 22-25 */
            uint32_t ProductTypeVdo2SOP                     :32;
        } PACK_STRUCT f;
        uint8_t buf[DRV_TPS6599X_TX_VID_REGISTER_LENGTH];
    };
} DRV_TPS6599X_TX_VID;

#define DRV_TPS_RX_VID_SOP   DRV_TPS6599X_RX_VID_SOP
...
{    
    ...
    union {
        ...
        uint8_t buf[DRV_TPS6599X_RX_VID_SOP_REGISTER_LENGTH];
    };
} DRV_TPS6599X_RX_VID_SOP;


#define DRV_TPS_RX_VID_SOPP   DRV_TPS6599X_RX_VID_SOPP
...
{    
    ...
    union {
        ...
        uint8_t buf[DRV_TPS6599X_RX_VID_SOPP_REGISTER_LENGTH];
    };
} DRV_TPS6599X_RX_VID_SOPP;

#define DRV_TPS_RX_VDM   DRV_TPS6599X_RX_VDM
...
{    
    ...
    union {
        ...
        uint8_t buf[DRV_TPS6599X_RX_VDM_REGISTER_LENGTH];
    };
} DRV_TPS6599X_RX_VDM;

/* length->1 address->0x50 */
typedef struct
{    
    uint8_t u8Length;
    union {
        struct {
						/* bytes 1 */
            uint8_t HostConnected                           :1;
            uint8_t SoftReset                               :1;
            uint8_t InterruptAck                            :1;
            uint8_t StatusNak                               :1;
            uint8_t Resv47                                  :4;
            /* bytes 2 */
            uint8_t Resv03                                  :4;
            uint8_t WriteToRetimer                          :1;
            uint8_t Hpd_Irq_ACK                             :1;
            uint8_t Hpd_IrqSticky                           :1;
            uint8_t HpdLevel                                :1;
            /* bytes 3~6 */
            uint32_t RetimerDebug                           :32;
        } PACK_STRUCT f;
        uint8_t buf[DRV_TPS6599X_DATA_CTRL_REGISTER_LENGTH];
    };
} DRV_TPS6599X_DATA_CTRL;

#define DRV_TPS_INTEL_VID_CONFIG DRV_TPS6599X_INTEL_VID_CONFIG
/* length->1 address->0x52 */
typedef struct
{    
    uint8_t u8Length;
    union {
        ...
        uint8_t buf[DRV_TPS6599X_INTEL_VID_CF_REGISTER_LENGTH];
    };
} DRV_TPS6599X_INTEL_VID_CONFIG;

#define DRV_TPS_GPIO_CONFIG   DRV_TPS6599X_GPIO_CONFIG

/* length->12 address->0x5C */
typedef struct
{    
    uint8_t u8Length;
    union {
        struct {
            ...
            uint32_t Gpio8_Oe                                :1;
            uint32_t Gpio9_Oe                                :1;
            uint32_t Gpio10_Oe                               :1;
            uint32_t Gpio11_Oe                               :1;
            uint32_t Resv1                                   :20;
					  
            /* bytes 5 ~ 8 */
            uint32_t Gpio0_Int                               :1;
            uint32_t Gpio1_Int                               :1;
            uint32_t Gpio2_Int                               :1;
            uint32_t Gpio3_Int                               :1;
            uint32_t Gpio4_Int                               :1;
            uint32_t Gpio5_Int                               :1;
            uint32_t Gpio6_Int                               :1;
            uint32_t Gpio7_Int                               :1;
            uint32_t Gpio8_Int                               :1;
            uint32_t Gpio9_Int                               :1;
            uint32_t Gpio10_Int                              :1;
            uint32_t Gpio11_Int                              :1;
            uint32_t Resv2                                   :20;
						
            /* bytes 9 ~ 12 */
            uint32_t Gpio0_Dat                               :1;
            uint32_t Gpio1_Dat                               :1;
            uint32_t Gpio2_Dat                               :1;
            uint32_t Gpio3_Dat                               :1;
            uint32_t Gpio4_Dat                               :1;
            uint32_t Gpio5_Dat                               :1;
            uint32_t Gpio6_Dat                               :1;
            uint32_t Gpio7_Dat                               :1;
            uint32_t Gpio8_Dat                               :1;
            uint32_t Gpio9_Dat                               :1;
            uint32_t Gpio10_Dat                              :1;
            uint32_t Gpio11_Dat                              :1;
            uint32_t Resv3                                   :20;

        } PACK_STRUCT f;
        uint8_t buf[DRV_TPS6599X_GPIO_CONFIG_REGISTER_LENGTH];
    };
} DRV_TPS6599X_GPIO_CONFIG;
...
{    
    ...
    union {
        ...
        uint8_t buf[DRV_TPS6599X_DATA_STATUS_REGISTER_LENGTH];
    };
} DRV_TPS6599X_DATA_STATUS;

#define DEV_TPS_GPIO_STATUS     DEV_TPS6599X_GPIO_STATUS

/* length->8 address->0x72 */
typedef struct
{    
    uint8_t u8Length;
    union {
        ...
        uint8_t buf[DRV_TPS6599X_GPIO_STATUS_REGISTER_LENGTH];
    };
} DRV_TPS6599X_GPIO_STATUS;

#define DRV_TPS_SLEEP_CONFIG   DRV_TPS6599X_SLEEP_CONFIG
...
{    
    ...
    union {
        ...
        uint8_t buf[DRV_TPS6599X_SLEEP_CONFIG_REGISTER_LENGTH];
    };
} DRV_TPS6599X_SLEEP_CONFIG;
...
typedef struct 
{
	uint8_t u8Length;
	pd_do_t xDo;
	uint16_t SourcePDOFlags : 10;
	uint16_t                : 6;
} DRV_TPS6599X_ACTIVE_CONTRACT_PDO;    // 0x34, len 6 + 1

typedef struct 
{
	uint8_t u8Length;
	pd_do_t xDo;
} DRV_TPS6599X_ACTIVE_CONTRACT_RDO;    // 0x35, len 4 + 1

typedef struct 
{
	uint8_t u8Length;
	pd_do_t xDo;
} DRV_TPS6599X_SINK_REQUEST_RDO;       // 0x36, len 4 + 1
...
#define amd_crb_drivers_tps_regAccess                      amd_crb_drivers_tps6599x_regAccess
/* Access I2C burst write for patch */
#define amd_crb_drivers_tps_burst_patch_download           amd_crb_drivers_tps6599x_burst_patch_download
/* Check the cmd done */
#define amd_crb_drivers_tps_wait4CmdDone                   amd_crb_drivers_tps6599x_wait4CmdDone
/* PD cmd and data write */
#define amd_crb_drivers_tps_cmdExecutor                    amd_crb_drivers_tps6599x_cmdExecutor
/* read the source rdo */
#define amd_crb_drivers_tps_readSrcRdo                     amd_crb_drivers_tps6599x_readSrcRdo
/* read the sink rdo */
#define amd_crb_drivers_tps_readSnkRdo                     amd_crb_drivers_tps6599x_readSnkRdo
/* Read sink Pdo */
#define amd_crb_drivers_tps_readSnkPdo                     amd_crb_drivers_tps6599x_readSnkPdo
/* get device info */
#define amd_crb_drivers_tps_deviceInfo                     amd_crb_drivers_tps6599x_deviceInfo
/* GPIO output config */
#define amd_crb_drivers_tps_gpioConfig                     amd_crb_drivers_tps6599x_gpioConfig
/* check if enter USB4 */
#define amd_crb_drivers_tps_isUsb4Enter                    amd_crb_drivers_tps6599x_isUsb4Enter
/* check if enter TBT */
#define amd_crb_drivers_tps_isTbtEnter                     amd_crb_drivers_tps6599x_isTbtEnter
/* update specific Tx VID for USB4 enable/disable */
#define amd_crb_drivers_tps_txVidUpdate                    amd_crb_drivers_tps6599x_txVidUpdate
/* change the model operation support bit */
#define amd_crb_drivers_tps_txVidChangeModelOpSupp         amd_crb_drivers_tps6599x_txVidChangeModelOpSupp
/* over write the tx vid register */
#define amd_crb_drivers_tps_txVidOverwrite                 amd_crb_drivers_tps6599x_txVidOverwrite
/* set sys power status */
#define amd_crb_drivers_tps_setSxAppConfig                 amd_crb_drivers_tps6599x_setSxAppConfig
/* config the type-c current */
#define amd_crb_drivers_tps_portCtrlTypecCurrent           amd_crb_drivers_tps6599x_portCtrlTypecCurrent
/* read the boot status */
#define amd_crb_drivers_tps_bootStatus                     amd_crb_drivers_tps6599x_bootStatus
/* config the sleep mode */
#define amd_crb_drivers_tps_sleepConfig                    amd_crb_drivers_tps6599x_sleepConfig
/* check the dead battery status */
#define amd_crb_drivers_tps_deadBattery                    amd_crb_drivers_tps6599x_deadBattery
/* enable or diable the pd */
#define amd_crb_drivers_tps_portConfigPdDisable            amd_crb_drivers_tps6599x_portConfigPdDisable
/* set and clear port config register */
#define amd_crb_drivers_tps_portConfig                     amd_crb_drivers_tps6599x_portConfig
/* config the port role */
#define amd_crb_drivers_tps_portConfigStateMachine         amd_crb_drivers_tps6599x_portConfigStateMachine
/* retry the failed 4cc commnad */
#define amd_crb_drivers_tps_cmdxRetry                      amd_crb_drivers_tps6599x_cmdxRetry
/* config the dr swap resposne */
#define amd_crb_drivers_tps_portCtrlDrSwapResp             amd_crb_drivers_tps6599x_portCtrlDrSwapResp
/* config the pr swap resposne */
#define amd_crb_drivers_tps_portCtrlPrSwapResp             amd_crb_drivers_tps6599x_portCtrlPrSwapResp
/* read the type-c current setting */
#define amd_crb_drivers_tps_readTypecCurrent               amd_crb_drivers_tps6599x_readTypecCurrent
/* set and clear port control register */
#define amd_crb_drivers_tps_portCtrl                       amd_crb_drivers_tps6599x_portCtrl

#if CONFIG_EC_UCSI_ENABLE
/* Send 4CC command */
#define amd_crb_drivers_tps_cmdx                           amd_crb_drivers_tps6599x_cmdx
/* Send the 4CC commnad for alt mode */
#define amd_crb_drivers_tps_cmdAltMode                     amd_crb_drivers_tps6599x_cmdAltMode
/* send ucsi related command */
#define amd_crb_drivers_tps_cmdUcsi                        amd_crb_drivers_tps6599x_cmdUcsi
/* Read the pd controller sink cap */
#define amd_crb_drivers_tps_devSnkCapInfo                  amd_crb_drivers_tps6599x_devSnkCapInfo
/* Refreash current pdo */
#define amd_crb_drivers_tps_refreashDevSnkCapCurrent       amd_crb_drivers_tps6599x_refreashDevSnkCapCurrent
/* Read the pd controller source cap */
#define amd_crb_drivers_tps_devSrcCapInfo                  amd_crb_drivers_tps6599x_devSrcCapInfo
/* Refreash current pdo */
#define amd_crb_drivers_tps_refreashDevSrcCapCurrent       amd_crb_drivers_tps6599x_refreashDevSrcCapCurrent
/* Read the pd partner sink cap */
#define amd_crb_drivers_tps_partnerSnkCapInfo              amd_crb_drivers_tps6599x_partnerSnkCapInfo
/* Read the pd partner source cap */
#define amd_crb_drivers_tps_partnerSrcCapInfo              amd_crb_drivers_tps6599x_partnerSrcCapInfo
/* Read the sop vid */
#define amd_crb_drivers_tps_readRxVidSop                   amd_crb_drivers_tps6599x_readRxVidSop
/* Read the sopp vid */
#define amd_crb_drivers_tps_readRxVidSopp                  amd_crb_drivers_tps6599x_readRxVidSopp
/* Read the sop svid */
#define amd_crb_drivers_tps_readRxSvidSop                  amd_crb_drivers_tps6599x_readRxSvidSop
/* Read any receive vdm */
#define amd_crb_drivers_tps_readVdmInfo                    amd_crb_drivers_tps6599x_readVdmInfo
/* Read pd controller alt mode info */
#define amd_crb_drivers_tps_altModeInfo                    amd_crb_drivers_tps6599x_altModeInfo
/* Clear the event2 int */
#define amd_crb_drivers_tps_intEvent2Clear                 amd_crb_drivers_tps6599x_intEvent2Clear
/* check the port role */
#define amd_crb_drivers_tps_portConfigStateMachineMatch    amd_crb_drivers_tps6599x_portConfigStateMachineMatch
/* get the default source cap */
#define amd_crb_drivers_tps_devSrcCapDeft                  amd_crb_drivers_tps6599x_devSrcCapDeft
/* get the default sink cap */
#define amd_crb_drivers_tps_devSnkCapDeft                  amd_crb_drivers_tps6599x_devSnkCapDeft
/* read the cable vdo */
#define amd_crb_drivers_tps_readCableVdo                   amd_crb_drivers_tps6599x_readCableVdo
/* update the source cap */
#define amd_crb_drivers_tps_devSrcCapUpdate                amd_crb_drivers_tps6599x_devSrcCapUpdate
/* update the sink cap */
#define amd_crb_drivers_tps_devSnkCapUpdate                amd_crb_drivers_tps6599x_devSnkCapUpdate
...
#endif // end of AMD_CRB_DRIVERS_TPS6599X_H_
