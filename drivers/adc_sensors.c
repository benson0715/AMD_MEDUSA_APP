...
/**
 * @brief Convert ADC raw value to temperature
 *
 * @param adc_raw_val Raw ADC value to convert
 * @param temperature Pointer to store the converted temperature
 */
...
/**
 * @brief Initialize ADC sensors
 *
 * @param adc_channel_bits Bitmask of ADC channels to enable
...
/**
 * @brief Read all configured ADC sensors and convert to temperature
 */
