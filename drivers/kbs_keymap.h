...
/**
 * @brief Concrete implementatoin for amdcrb keyboard init.
 *
 * @retval Forward a keyboard API to the caller.
 */
struct km_api *amdcrb_init();
...
{
#if defined(CONFIG_EC_AMDCRB_KEYBOARD)
	return amdcrb_init();
#else
	return NULL;
#endif
