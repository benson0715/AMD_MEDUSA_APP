...
#define EC_ACPI_INTR_DIS     0
#define EC_ACPI_INTR_EN      1
 ...
 * @retval the byte sent.
 */
uint32_t port80_read_idr(enum acpi_ec_interface num);
...
/**
 * @brief config the ibf interrupt enable/disable
 *l
 */
void acpi_ibf_intr(enum acpi_ec_interface num, bool val);

/**
 * @brief config the obe interrupt enable/disable
 *l
 */
