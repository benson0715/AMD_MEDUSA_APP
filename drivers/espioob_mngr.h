...
#define OOB_MASTER_ADDR_FCH			0x08U
...
/* OOB command codes for master: PSP */
#define OOB_CMD_CODE_TEMP			0x01U

/* OOB byte count for OOB messages */
#define OOB_BYTE_CNT_FCH_REQ_MSG		0x01U
