...
/**
 * @brief Get the Winbond SAF configuration
 *
 * @return Pointer to the SAF configuration structure
 */
...
/**
 * @brief Get a QSPI command transaction structure by index
 *
 * @param command The command index to retrieve
 * @return Pointer to the corresponding SAF SPI transaction structure
 */
