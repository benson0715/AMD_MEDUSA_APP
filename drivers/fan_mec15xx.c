...
/**
 * @brief Initialize PWM device bindings
 *
 * Binds all available PWM devices based on devicetree status.
 */
...
/**
 * @brief Initialize tachometer device bindings
 *
 * Binds all available tachometer devices based on devicetree status.
 */
...
/**
 * @brief Initialize fan subsystem with provided fan table
 *
 * @param size Number of fan entries in the table
 * @param fan_tbl Pointer to fan device configuration table
 ...
 *
 * @param power_state true to enable fan power, false to disable
 * @return 0 on success, negative error code on failure
 */
...
/**
 * @brief Set fan duty cycle
 *
 * @param fan_idx Fan index to control
...
/**
 * @brief Read fan RPM from tachometer
 *
 * @param fan_idx Fan index to read
