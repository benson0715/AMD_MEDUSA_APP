...
Nuvoton npcx4mnx_demo
####################

Overview
********

The npcx4mnx_demo kit is a development platform to evaluate the
Nuvoton NPCX4 series microcontrollers. This board needs to be mated with
part number NPCX498F.

.. image:: npcx4mnx_demo.jpg
     :align: center
...
``boards/arm/npcx4mnx_demo/npcx4mnx_demo_defconfig``
...
Build and flash the blinky sample.::
  ...
  west build -t clean && \
    west build -c -p auto -b npcx4mnx_demo samples/basic/blinky && \
